...
public class Pathfinder {
    ...
    static boolean arrayContains(MapLocation[] arr, MapLocation loc) {
        return (arr[0] != null && arr[0].equals(loc)) || (arr[1] != null && arr[1].equals(loc)) || (arr[2] != null && arr[2].equals(loc))
                || (arr[3] != null && arr[3].equals(loc)) || (arr[4] != null && arr[4].equals(loc));
    }
    ...
    static Direction getMoveDirBFS(RobotController rc, MapLocation tgt) throws GameActionException {
        MapLocation src = rc.getLocation();
        int range = 8;
        MapLocation immTgt;
